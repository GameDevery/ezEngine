...
public:
    ...
    ezSharedPtr<BindingSetLayout> GetBindingSetLayout(const ezDynamicArray<BindKey>& keys);
...
private:
    ...
    ezMap<ezDynamicArray<BindKey>, ezSharedPtr<BindingSetLayout>> m_layout_cache;
