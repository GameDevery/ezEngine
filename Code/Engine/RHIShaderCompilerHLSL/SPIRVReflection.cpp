...
ResourceBindingDesc GetBindingDesc(const spirv_cross::CompilerHLSL& compiler, const spirv_cross::Resource& resource)
{
  ...
  switch (desc.type)
  {
    ...
    case ViewType::kRWStructuredBuffer:
    {
      ...
      desc.structure_stride = (ezUInt32)(compiler.get_declared_struct_size_runtime_array(base_type, 1) - compiler.get_declared_struct_size_runtime_array(base_type, 0));
